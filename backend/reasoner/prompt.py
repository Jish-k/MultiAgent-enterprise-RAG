...
ANALYSIS_SYSTEM_PROMPT = """You are an expert Evidence Analyst for a complex reasoning system.
...
GENERATION_SYSTEM_PROMPT = """You are a highly precise AI Assistant.

...
from reasoner.analyzer import EvidenceAnalyzer
from reasoner.generator import DraftGenerator
from reasoner.models import ReasoningOutput, ReasoningAnalysis, ReasonerMetrics
...
class ReasonerAgent:
    ...
    def __init__(self, api_key: str = None, anthropic_api_key: str = None, llm_provider: str = "openai"):
        llm = get_llm(api_key=api_key, anthropic_api_key=anthropic_api_key, llm_provider=llm_provider)
        self.analyzer = EvidenceAnalyzer(llm=llm)
        self.generator = DraftGenerator(llm=llm)
